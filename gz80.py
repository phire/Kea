...
class gz80(Processor):
	...
	def decodeInstruction(self, state, stream):
		...
		if x == 2:
			if y == 0:
				return Instruction("add a,%s" % reg[z],
						{"pc": [add, "pc", 1],
						 "a": [add, "a", reg[z]],
						 "z": [eq, [xorl, [add, "a", reg[z]], 0xff], 0],
						 "n": 0,
						 "h": [gt, [add, [xorl, "a", 0xf], [xorl, reg[z], 0xf]], 0xf],
						 "c": [gt, [add, "a", reg[z]], 0xff]})
			if y == 1:
				return Instruction("adc a,%s" % reg[z],
						{"pc": [add, "pc", 1],
						 "a": [add, [add, "a", reg[z]], "c"],
						 "z": [eq, [xorl, [add, [add, "a", reg[z]], "c"], 0xff], 0],
						 "n": 0,
						 "h": [gt, [add, [add, [xorl, "a", 0xf], [xorl, reg[z], 0xf]], "c"], 0xf],
						 "c": [gt, [add, [add, "a", reg[z]], "c"], 0xff]})
			if y == 2:
				return Instruction("sub %s" % reg[z],
						{"pc": [add, "pc", 1],
						 "a": [sub, "a", reg[z]],
						 "z": [eq, [mod, [sub, "a", reg[z]], 0xff], 0],
						 "n": 1,
						 "h": [gt, [add, [xorl, "a", 0xf], [xorl, reg[z], 0xf]], 0xf],
						 "c": [gt, [add, "a", reg[z]], 0xff]})
			if y == 3:
				return Instruction("sbc a,%s" % reg[z],
						{"pc": [add, "pc", 1],
						 "a": [sub, [sub, "a", reg[z]], "c"],
						 "z": [eq, [mod, [sub, [sub, "a", reg[z]], "c"], 0xff], 0],
						 "n": 1,
						 "h": [gt, [sub, [sub, [xorl, "a", 0xf], [xorl, reg[z], 0xf]], "c"], 0xf],
						 "c": [gt, [sub, [sub, "a", reg[z]], "c"], 0xff]})
			if y == 4:
				return Instruction("and %s" % reg[z],
						{"pc": [add, "pc", 1],
						 "a": [andl, "a", reg[z]],
						 "z": [eq, [andl, "a", reg[z]], 0],
						 "n": 0, "h": 1, "c": 0})
			if y == 5: 
				return Instruction("xor %s" % reg[z],
						{"pc": [add, "pc", 1],
						 "a": [xorl, "a", reg[z]],
						 "z": [eq, [xorl, "a", reg[z]], 0],
						 "n": 0, "h": 0, "c": 0})
			if y == 6:
				return Instruction("or %s" % reg[z],
						{"pc": [add, "pc", 1],
						 "a": [orl, "a", reg[z]],
						 "z": [eq, [orl, "a", reg[z]], 0],
						 "n": 0, "h": 0, "c": 0})
			if y == 7:
				return Instruction("cp %s" % reg[z], 
						{"pc": [add, "pc", 1],
						 "z": [eq, [mod, [sub, "a", reg[z]], 0xff], 0],
						 "n": 1,
						 "h": [gt, [add, [xorl, "a", 0xf], [xorl, reg[z], 0xf]], 0xf],
